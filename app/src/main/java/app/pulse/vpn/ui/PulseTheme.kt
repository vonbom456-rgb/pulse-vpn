...
private fun darkColors(accent: String) = darkPalette(accent).let { palette -> darkColorScheme(
    ...
    surfaceBright = palette.surfaceVariant,
    surfaceContainerLowest = palette.background,
    surfaceContainerLow = androidx.compose.ui.graphics.lerp(palette.surface, palette.background, .4f),
    surfaceContainer = palette.surface,
    surfaceContainerHigh = androidx.compose.ui.graphics.lerp(palette.surface, palette.surfaceVariant, .5f),
    ...
    error = Color(0xFFFFA2B1),
    onError = Color(0xFF5B001A),
    errorContainer = Color(0xFF461624),
...
private fun lightColors(accent: String) = lightPalette(accent).let { palette -> lightColorScheme(
    ...
    outlineVariant = palette.surfaceVariant,
    surfaceTint = palette.primary,
    surfaceDim = palette.surfaceVariant,
    surfaceBright = palette.surface,
    surfaceContainerLowest = palette.surface,
    surfaceContainerLow = palette.background,
    surfaceContainer = androidx.compose.ui.graphics.lerp(palette.background, palette.surfaceVariant, .3f),
    surfaceContainerHigh = androidx.compose.ui.graphics.lerp(palette.background, palette.surfaceVariant, .6f),
    surfaceContainerHighest = palette.surfaceVariant,
    inverseSurface = palette.onSurface,
    inverseOnSurface = palette.surface,
    inversePrimary = palette.primaryContainer,
    ...
    onTertiary = palette.onSecondary,
    onTertiaryContainer = palette.onSecondaryContainer,
    error = Color(0xFFAF183B),
    onError = Color.White,
    errorContainer = Color(0xFFFFD9DE),
    onErrorContainer = Color(0xFF410017),
)}
