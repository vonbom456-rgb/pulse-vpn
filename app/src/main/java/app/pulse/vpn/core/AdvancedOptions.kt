...
object OptionCatalog {
    ...
    val all = listOf(
        ...
        choice("connect_timeout", "Ожидание подключения", "После тайм-аута запуск отменяется и появляется действие повтора.", "Туннель", "30", "15" to "15 с", "30" to "30 с", "60" to "60 с"),
        ...
        choice("ping_timeout", "Тайм-аут TCP-проверки", "Ожидание ответа одного адреса. Проверка без VPN не измеряет скорость туннеля.", "Проверка серверов", "1200", "800" to "0,8 с", "1200" to "1,2 с", "2500" to "2,5 с", "5000" to "5 с"),
        ...
        toggle("secure_screen", "Защита снимков экрана", "Запрещает скриншоты и скрывает приложение в недавних. Может отключить трансляцию экрана.", "Приватность"),
        ...
        toggle("compact_card", "Компактная подписка", "По умолчанию скрывает подробности, оставляя срок и действия.", "Интерфейс"),
        ...
        choice("refresh_hours", "Не обновлять чаще", "Минимальный интервал автообновления при открытии. Ручное обновление доступно всегда.", "Обновление подписок", "0", "0" to "Всегда", "1" to "1 час", "6" to "6 часов", "24" to "Сутки"),
    )
